...
const NotificationDropdown = ({
  ...
  return (
    <div className="absolute right-0 mt-2 w-80 origin-top-right rounded-md bg-white dark:bg-gray-900 shadow-lg ring-1 ring-gray-300 ring-opacity-5 focus:outline-none z-40">
