  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`"relative rounded-md p-2 ${color}
        dark:text-amber-50 hover:text-yellow-500 hover:bg-text-soft focus:outline-none cursor-pointer transition duration-300" `}
      >
        <Bell size={iconSize} />
        {unreadCount > 0 && (
